...
//---------------------------------------------------------------------------------------------
// 1.0     | 10-Jun-2012   | Jac. Beekers    | New
//---------------------------------------------------------------------------------------------
//
// Purpose:
//	Move files using rows in fitnesse "script "table
//  The choice was to make use of Linux commands to mimic the actual way
//    the non-Java application will move/copy files.
//  At a later point it may be decided this is no longer needed, and the code
//    may be replaced by using the much simpler java io methods.
//
//---------------------------------------------------------------------------------------------
...
//
  ...
  public Parameters(String context) {
    java.util.Date started=new java.util.Date();
    SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
    m_startDate = sdf.format(started);
  m_context=context;
