...
public class RunScript {
    ...
    public RunScript(String scriptName, String context) {    
            this.scriptName = scriptName;    
      java.util.Date started = new java.util.Date();
      SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
      this.startDate = sdf.format(started);
     ...
     */
    public String runScriptReturnCode() throws RunScriptStopTest {
        ...
        try {
            ...
            printUsedParameters();
            log(myName, Constants.INFO, myArea,"Command line is >" + fullPathScript + " " + parameter + "<.");


            process = rt.exec(fullPathScript + " " + parameter);
            ...
            try {
                ...
                if (Constants.YES.equals(getAbortOnError())) {
                    throw new RunScriptStopTest(getErrorMessage());
                }
    ...
    */
    ...
    private String DetermineCompleteFileName(String directory,
                                             String fileName) throws RunScriptStopTest {
    ...
    public String getResultValue(String resultProperty) throws RunScriptStopTest {
        return getResultValue(getResultFileName(), resultProperty);
    }
    
    public String getResultValue(String resultFileName, String resultProperty) throws RunScriptStopTest {
...
//        GetParameters getParam = new GetParameters();
        myArea="result";
        val=nl.consag.supporting.GetParameters.getPropertyVal(fullPathResultFile, resultProperty);
        
        if(Constants.OK.equals(nl.consag.supporting.GetParameters.getErrorCode())) {
            log(myName, Constants.DEBUG, myArea, "GetParameters returned OK");
            return val;
        } else {
            log(myName, Constants.DEBUG, myArea, "GetParameters returned >" + nl.consag.supporting.GetParameters.getErrorCode() +"<.");
            return nl.consag.supporting.GetParameters.getErrorCode() +": " + nl.consag.supporting.GetParameters.getErrorMessage();
        }
        
    }

    
    static public class RunScriptStopTest extends Exception {
        @SuppressWarnings("compatibility:-3791609920751125135")
        private static final long serialVersionUID = 1L;

        public RunScriptStopTest() {
        }

        /**
         * @param msg
         */
        public RunScriptStopTest(String msg) {
            super(msg);
        }
